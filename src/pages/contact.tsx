...
const confetti = {
  light: {
    primary: 'E1E3BB7F', // blue.400
    secondary: 'B58034', // blue.100
  },

  dark: {
    primary: 'B58034', // blue.900
    secondary: 'B58034', // blue.800
  },
};
...
const formSchema = z.object({
  name: z.string().min(1, { message: "A name is required" }).max(30, { message: "Max 30 characters" }),
  email: z.string().min(1, { message: "An email is required" }).email({
		message: "Must be a valid email",
	}),
	phone: z.string().max(14, { message: "Incorrect phone format" }).optional(),
  message: z.string().min(1, { message: "A message is required" }).max(255, { message: "Max 255 characters" })
})
